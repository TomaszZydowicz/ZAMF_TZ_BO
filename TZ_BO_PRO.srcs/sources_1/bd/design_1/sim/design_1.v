...
module design_1
  ...
  wire [15:0]sample_switch_0_out_i2s441kH_sample;
  ...
  design_1_flip_flop_0_0 flip_flop_0
       (.D(rx_pmode_1),
        .Q(flip_flop_0_out),
        .clk(clk_wiz_0_clk_out1),
        .enable(xlconstant_3_dout));
  design_1_flip_flop_1_0 flip_flop_1
       (.D(uart_tx_0_out_Tx_Serial),
        .Q(flip_flop_1_Q),
        .clk(clk_wiz_0_clk_out1),
