...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net flip_flop_0_out [get_bd_pins flip_flop_0/Q] [get_bd_pins uart_rx_0/in_Rx_Serial]
  connect_bd_net -net flip_flop_1_Q [get_bd_ports tx_pmode] [get_bd_pins flip_flop_1/Q]
  ...
  connect_bd_net -net uart_tx_0_out_Tx_Serial [get_bd_pins flip_flop_1/D] [get_bd_pins uart_tx_0/out_Tx_Serial]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins flip_flop_0/enable] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins flip_flop_1/enable] [get_bd_pins xlconstant_4/dout]
