...
architecture STRUCTURE of design_1_sample2uart_0_0_sample2uart is
  ...
  signal in_sample_reg : STD_LOGIC_VECTOR ( 23 downto 0 );
  signal in_sample_reg_0 : STD_LOGIC;
  ...
  signal out_ready_sample_switch_reg_i_3_n_0 : STD_LOGIC;
  signal \^out_ready_sample_switch_reg_reg_0\ : STD_LOGIC;
  signal \^out_ready_uart\ : STD_LOGIC;
  signal out_uart_frame_reg : STD_LOGIC;
  signal out_uart_frame_reg0_in : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal state : STD_LOGIC_VECTOR ( 2 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "FIRST_HALF_SAMPLE:001,SECOND_HALF_SAMPLE:011,FIRST_HALF_SAMPLE_WAIT:010,THIRD_HALF_SAMPLE:101,SECOND_HALF_SAMPLE_WAIT:100,IDLE:000,THIRD_HALF_SAMPLE_WAIT:110";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "FIRST_HALF_SAMPLE:001,SECOND_HALF_SAMPLE:011,FIRST_HALF_SAMPLE_WAIT:010,THIRD_HALF_SAMPLE:101,SECOND_HALF_SAMPLE_WAIT:100,IDLE:000,THIRD_HALF_SAMPLE_WAIT:110";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "FIRST_HALF_SAMPLE:001,SECOND_HALF_SAMPLE:011,FIRST_HALF_SAMPLE_WAIT:010,THIRD_HALF_SAMPLE:101,SECOND_HALF_SAMPLE_WAIT:100,IDLE:000,THIRD_HALF_SAMPLE_WAIT:110";
  attribute SOFT_HLUTNM of one_cykle_delay_couner_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of out_ready_sample_switch_reg_i_3 : label is "soft_lutpair1";
begin
  out_ready_sample_switch_reg_reg_0 <= \^out_ready_sample_switch_reg_reg_0\;
  out_ready_uart <= \^out_ready_uart\;
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF00000C00000CAA"
    )
        port map (
      I0 => \out_ready_sample_switch_reg1__1\,
      I1 => one_cykle_delay_couner_reg_n_0,
      I2 => tx_busy,
      I3 => state(1),
      I4 => state(0),
      I5 => state(2),
...
\in_sample_reg[23]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\in_sample_reg_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\in_sample_reg_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
out_ready_sample_switch_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => state(2),
      I3 => state(1),
      I4 => out_ready_sample_switch_reg_i_3_n_0,
      I5 => \^out_ready_sample_switch_reg_reg_0\,
      O => out_ready_sample_switch_reg_i_1_n_0
    );
out_ready_sample_switch_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
out_ready_sample_switch_reg_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => one_cykle_delay_couner_reg_n_0,
      I1 => tx_busy,
      O => out_ready_sample_switch_reg_i_3_n_0
    );
...
\out_uart_frame_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(0),
      O => out_uart_frame_reg0_in(0)
    );
\out_uart_frame_reg[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(1),
      O => out_uart_frame_reg0_in(1)
    );
\out_uart_frame_reg[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(2),
      O => out_uart_frame_reg0_in(2)
    );
\out_uart_frame_reg[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(3),
      O => out_uart_frame_reg0_in(3)
    );
\out_uart_frame_reg[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(4),
      O => out_uart_frame_reg0_in(4)
    );
\out_uart_frame_reg[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(5),
      O => out_uart_frame_reg0_in(5)
    );
\out_uart_frame_reg[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
      ...
      I3 => state(2),
      I4 => in_sample_reg(6),
      O => out_uart_frame_reg0_in(6)
    );
\out_uart_frame_reg[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
      ...
      I1 => state(2),
      I2 => state(1),
      O => out_uart_frame_reg
    );
\out_uart_frame_reg[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
...
\out_uart_frame_reg_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => in_clk,
      CE => out_uart_frame_reg,
      D => out_uart_frame_reg0_in(0),
      Q => out_uart_frame(0),
      R => '0'
    );
...
inst: entity work.design_1_sample2uart_0_0_sample2uart
     port map (
      in_clk => in_clk,
      in_en => in_en,
      in_sample(23 downto 0) => in_sample(23 downto 0),
