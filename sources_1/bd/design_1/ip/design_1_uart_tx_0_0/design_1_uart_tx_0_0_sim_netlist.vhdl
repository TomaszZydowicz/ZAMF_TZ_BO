...
architecture STRUCTURE of design_1_uart_tx_0_0_uart_tx is
  ...
  signal Clock_Count_reg : STD_LOGIC_VECTOR ( 6 downto 1 );
  signal Clock_Count_reg0 : STD_LOGIC;
  signal \Clock_Count_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \Clock_Count_reg[6]_i_4_n_0\ : STD_LOGIC;
  signal Clock_Count_reg_0 : STD_LOGIC;
  signal Clock_Count_reg_reg : STD_LOGIC_VECTOR ( 6 downto 1 );
  ...
  attribute SOFT_HLUTNM of \Bit_Index_reg[2]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Clock_Count_reg[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Clock_Count_reg[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Clock_Count_reg[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Clock_Count_reg[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Clock_Count_reg[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Clock_Count_reg[6]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of out_Tx_Serial_i_1 : label is "soft_lutpair2";
begin
...
\Clock_Count_reg[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"54"
    )
        port map (
...
\Clock_Count_reg[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
      I0 => Clock_Count_reg_reg(6),
      I1 => Clock_Count_reg_reg(5),
      I2 => \Clock_Count_reg[6]_i_4_n_0\,
      I3 => Tx_Active_reg_i_2_n_0,
      O => Clock_Count_reg(6)
    );
\Clock_Count_reg[6]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
Tx_Active_reg_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => Clock_Count_reg_reg(5),
      I1 => Clock_Count_reg_reg(1),
      I2 => Clock_Count_reg_reg(2),
      I3 => Clock_Count_reg_reg(3),
      I4 => Clock_Count_reg_reg(4),
      I5 => Clock_Count_reg_reg(6),
