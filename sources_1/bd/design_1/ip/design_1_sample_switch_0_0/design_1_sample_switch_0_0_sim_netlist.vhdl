...
entity design_1_sample_switch_0_0_sample_switch is
  port (
    out_uart_sample : out STD_LOGIC_VECTOR ( 23 downto 0 );
    out_i2s441kH_sample : out STD_LOGIC_VECTOR ( 23 downto 0 );
...
architecture STRUCTURE of design_1_sample_switch_0_0_sample_switch is
  ...
  signal \reg_out_uart_sample[23]_i_1_n_0\ : STD_LOGIC;
...
\reg_out_i2s441kH_sample[23]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\reg_out_i2s441kH_sample_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_i2s441kH_sample_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample[23]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\reg_out_uart_sample_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_out_uart_sample_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
entity design_1_sample_switch_0_0 is
  port (
    ...
    out_uart_sample : out STD_LOGIC_VECTOR ( 23 downto 0 );
    out_i2s441kH_sample : out STD_LOGIC_VECTOR ( 23 downto 0 );
    out_i2s2H_sample : out STD_LOGIC_VECTOR ( 23 downto 0 );
    fifo_en : out STD_LOGIC;
    sample2uart_en : out STD_LOGIC;
...
begin
  i2s2H_en <= \<const0>\;
  out_i2s2H_sample(23) <= \<const0>\;
  out_i2s2H_sample(22) <= \<const0>\;
  out_i2s2H_sample(21) <= \<const0>\;
  out_i2s2H_sample(20) <= \<const0>\;
  out_i2s2H_sample(19) <= \<const0>\;
  out_i2s2H_sample(18) <= \<const0>\;
  out_i2s2H_sample(17) <= \<const0>\;
  out_i2s2H_sample(16) <= \<const0>\;
...
inst: entity work.design_1_sample_switch_0_0_sample_switch
     port map (
      ...
      out_i2s441kH_sample(23 downto 0) => out_i2s441kH_sample(23 downto 0),
      out_uart_sample(23 downto 0) => out_uart_sample(23 downto 0),
      sample2uart_en => sample2uart_en
    );
end STRUCTURE;
