...
architecture STRUCTURE of design_1_uart2sample_0_0_uart2sample is
  signal \FSM_sequential_uart_frame_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_sequential_uart_frame_counter[1]_i_1_n_0\ : STD_LOGIC;
  signal \^out_ready\ : STD_LOGIC;
  signal p_0_out : STD_LOGIC_VECTOR ( 23 downto 7 );
  signal reg_out_ready_i_1_n_0 : STD_LOGIC;
  signal uart_frame_counter : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_uart_frame_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_uart_frame_counter_reg[0]\ : label is "iSTATE:00,iSTATE0:01,iSTATE1:10";
  attribute FSM_ENCODED_STATES of \FSM_sequential_uart_frame_counter_reg[1]\ : label is "iSTATE:00,iSTATE0:01,iSTATE1:10";
  attribute SOFT_HLUTNM of reg_out_ready_i_1 : label is "soft_lutpair0";
begin
  out_ready <= \^out_ready\;
\FSM_sequential_uart_frame_counter[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
\FSM_sequential_uart_frame_counter[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E4"
    )
        port map (
...
\FSM_sequential_uart_frame_counter_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\FSM_sequential_uart_frame_counter_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\reg_frame[23]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\reg_frame[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\reg_frame_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_frame_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
reg_out_ready_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAC8"
    )
        port map (
