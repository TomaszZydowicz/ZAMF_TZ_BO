...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2s is
  ...
  signal BCLK_negedge_i_2_n_0 : STD_LOGIC;
  ...
  signal \PBLRC_counter[10]_i_4_n_0\ : STD_LOGIC;
  signal \PBLRC_counter[6]_i_2_n_0\ : STD_LOGIC;
  signal \PBLRC_counter[8]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \bit_counter[15]_i_1_n_0\ : STD_LOGIC;
  signal \bit_counter[15]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \bit_counter_reg[15]_i_3_n_2\ : STD_LOGIC;
  signal \bit_counter_reg[15]_i_3_n_3\ : STD_LOGIC;
  ...
  signal reg_out_PBDAT_i_3_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_i_6_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_i_7_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_i_8_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_i_9_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_reg_i_2_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_reg_i_4_n_0 : STD_LOGIC;
  signal reg_out_PBDAT_reg_i_5_n_0 : STD_LOGIC;
  signal reg_out_PBLRC_i_1_n_0 : STD_LOGIC;
  signal reg_out_PBLRC_i_2_n_0 : STD_LOGIC;
  signal reg_out_PBLRC_i_3_n_0 : STD_LOGIC;
  signal reg_out_PBLRC_i_4_n_0 : STD_LOGIC;
  signal reg_out_PBLRC_i_5_n_0 : STD_LOGIC;
  ...
  signal \reg_sample[15]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \NLW_bit_counter_reg[15]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_bit_counter_reg[15]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \BCLK_counter[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \BCLK_counter[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \BCLK_counter[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of BCLK_negedge_i_2 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \MCLK_counter[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \PBLRC_counter[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \PBLRC_counter[10]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \PBLRC_counter[10]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \PBLRC_counter[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \PBLRC_counter[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \PBLRC_counter[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \PBLRC_counter[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \PBLRC_counter[6]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \PBLRC_counter[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \PBLRC_counter[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bit_counter[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of canal_counter_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \quick_state_counter[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \quick_state_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of reg_out_MUTE_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of reg_out_PBLRC_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of reg_out_PBLRC_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of reg_out_PBLRC_i_5 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of reg_out_ready_i_3 : label is "soft_lutpair1";
...
BCLK_negedge_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2E2A"
    )
        port map (
...
BCLK_negedge_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\PBLRC_counter[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2A80"
    )
        port map (
...
\PBLRC_counter[10]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\PBLRC_counter[10]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\bit_counter[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\bit_counter_reg[15]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \bit_counter_reg[12]_i_1_n_0\,
      CO(3 downto 2) => \NLW_bit_counter_reg[15]_i_3_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \bit_counter_reg[15]_i_3_n_2\,
      CO(0) => \bit_counter_reg[15]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_bit_counter_reg[15]_i_3_O_UNCONNECTED\(3),
...
canal_counter_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
reg_out_BCLK_i_1: unisim.vcomponents.LUT6
    generic map(
...
reg_out_PBDAT_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2F2FFF0020200000"
    )
        port map (
...
reg_out_PBDAT_i_10: unisim.vcomponents.LUT6
    generic map(
...
reg_out_PBDAT_i_11: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
reg_out_PBDAT_i_3: unisim.vcomponents.LUT6
    generic map(
...
reg_out_PBDAT_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
reg_out_PBDAT_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
reg_out_PBDAT_reg_i_2: unisim.vcomponents.MUXF8
     port map (
...
reg_out_PBDAT_reg_i_5: unisim.vcomponents.MUXF7
     port map (
...
reg_out_PBLRC_i_2: unisim.vcomponents.LUT6
    generic map(
...
reg_out_PBLRC_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
reg_out_PBLRC_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
reg_out_PBLRC_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\reg_sample[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F20"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "i2s,Vivado 2019.2";
