...
HD_PWD='D:/Foldery/Studia/MGR/SEM2/ZAMPF/projekt/TZ_BO_PRO/TZ_BO_PRO.runs/design_1_uart2sample_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_uart2sample_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_uart2sample_0_0.tcl
