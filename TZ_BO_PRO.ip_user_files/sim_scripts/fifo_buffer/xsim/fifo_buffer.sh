...
#
# Generated by Vivado on Mon Dec 12 21:54:07 +0100 2022
...
# Script info
echo -e "fifo_buffer.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_buffer xil_defaultlib.fifo_buffer xil_defaultlib.glbl -log elaborate.log
}
